...
export default function Navigation({lang} : {lang : string}) {
  ...
  return (
    ...
    <header className="flex z-30 bg-light-blue-100 backdrop-blur-3xl dark:bg-dark-blue-550 justify-center rounded-b-md mb-6 max-w-[1400px] w-full mx-auto top-0 sticky">
        ...
        <DropdownButton elementsClass="text-xs sm:text-base dark:bg-dark-blue-650" className=" h-full !bg-light-blue-100 dark:!bg-transparent dark:hover:!bg-dark-blue-500 dark:text-dark-blue-200 hover:!bg-light-blue-150 !rounded-none *:text-xs *:sm:text-base" name={dict.lang} elements={language} />
      </header>
    </>
  );
}
