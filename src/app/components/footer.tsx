...
export default function Footer() {
  return (
    <footer className="flex flex-col justify-center items-center bg-dark-gradient-bg py-2.5 px-4">
      <p className="text-center">{en.footer.credits}</p>
      <Link
        className="flex gap-1.5 p-1.5 bg-dark-blue-400 rounded-md hover:bg-black transition-all active:scale-95"
